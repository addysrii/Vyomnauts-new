...
//           animation: `goldTwinkle ${Math.random() * 4 + 2}s infinite ease-in-out`,
...
//       <div className="bg-black border-2 border-yellow-500/30 rounded-3xl p-12 backdrop-blur-lg
//                     shadow-[0_0_50px_rgba(255,215,0,0.1)] hover:shadow-[0_0_70px_rgba(255,215,0,0.2)]
//                     transition-all duration-500">
//         <div className="grid md:grid-cols-2 gap-12 items-center">
//           <div className="space-y-8">
//             <div>
//               <h3 className="text-4xl font-bold bg-gradient-to-r from-yellow-300 to-yellow-500 
...
//                 <div 
//                   key={unit} 
//                   className="bg-black border-2 border-yellow-500/30 rounded-xl p-6 text-center 
...
//                     {value}
//                   </div>
//                   <div className="text-sm text-yellow-200/80 capitalize mt-2">
//                     {unit}
//                   </div>
//                 </div>
//               ))}
...
//               alt={projects[0].name}
//               className="relative rounded-xl w-full h-96 object-cover transform 
